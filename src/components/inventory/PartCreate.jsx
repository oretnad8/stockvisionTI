...
const PartCreate = ({ onClose }) => {
    const { createItem, loading, error: contextError } = useInventory();
    ...
    return (
        <div className="fixed inset-0 z-[75] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            <div className="bg-[#0f172a] w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-bottom-4 duration-300 border border-slate-800">
                <div className="p-6 border-b border-slate-800 flex justify-between items-center bg-[#1e293b]">
                    <div>
                        <span className="inline-block px-2 py-0.5 bg-blue-500/20 text-blue-400 text-[10px] font-bold uppercase tracking-wider rounded mb-1">Nuevo Registro</span>
                        <h2 className="text-xl font-bold text-white">Agregar Ítem</h2>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[75vh]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                placeholder="Ej: Router Cisco ISR"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full px-4 py-2.5 bg-[#1e293b] text-white border border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none placeholder-slate-500"
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-800 flex gap-3">
                        ...
                        >
                            <Save size={18} />
                            {loading ? 'Procesando...' : 'Guardar Ítem'}
                        </button>
                    </div>
                </form>
            </div>
